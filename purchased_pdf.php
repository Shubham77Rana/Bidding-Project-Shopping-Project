...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0,10,'TheBidders(Purchased Item Report)','B',0,'C');
        $this->Ln(20);
    }
...
$pdf = new PDF();
$header = array('Item Name', 'Buy Date', 'Buy Amount', 'Total Bidders','Seller');
...
{
    $query1=mysqli_query($connect,"select item_name,seller from items where item_id='".$row['item_id']."'") or die(mysqli_error($connect));
