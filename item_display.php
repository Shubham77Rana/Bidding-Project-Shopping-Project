 <?php
    ...
    $query=mysqli_query($connect,"select * from items where item_id in(select item_id from bid where username='$username') and bsbe=0")
    ...
    $query=mysqli_query($connect,"select * from items where item_id not in(select item_id from bid where username='$username') and bsbe=0")
     or die(mysqli_error($connect));
